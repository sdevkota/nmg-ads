        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
           ...
           We Will Come To You And Create Real Videos & Podcasts For Your Business?
            ...
            <h2 className="text-3xl font-bold py-5">AI videos feel impersonal—your customers want to connect with YOU and your vision.</h2>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <button 
                ...
                className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white hover:cursor-pointer focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-white dark:border-gray-200 dark:hover:text-white dark:hover:bg-gray-700"
              >
                Free Consultation
              </button>
              <button 
